...
public class IssuedHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_issued_history);
        recyclerView = findViewById(R.id.issuedView);

        GridLayoutManager gridLayoutManager = new GridLayoutManager(IssuedHistoryActivity.this, 1);
        ...
        dataList.add(androidData);
        adapter = new LibraryAdapter(IssuedHistoryActivity.this, dataList,false);
